...
defineFeature(feature, (test) => {
  ...
  test("Happy Path - Post Request to /fetchquestions Endpoint for userId with Nino <selectedNino>", ({
    ...
    given(
      /^I send a new fetchquestions request to the core stub with nino value (.*) for user (.*)$/,
  ...
  test("Happy Path - Post Request to /fetchquestions Endpoint for same userId with Nino <selectedNino", ({
    ...
    given(
      /^I send a fetchquestions request to the core stub with nino value (.*) for user (.*)$/,
      async (selectedNino, userId) => {
        await generateClaimsUrl(selectedNino, userId);
        await postUpdatedClaimsUrl(false);
        await postRequestToSessionEndpoint();
  ...
  test("Happy Path - Post Request to /fetchquestions Endpoint for userId with Nino <selectedNino> with only low confidence questionKey", ({
    given,
    when,
    then,
  }) => {
