Feature: HMRC-KBV-POST-Answer-HappyPath.feature
    ...
    Scenario Outline: Happy Path - Post request to /answer Endpoint for nino <selectedNino> with >=3 questions over 2 questionKeys
        ...
        Examples:
            | contentType      | accept           | statusCode | intermediateStatusCode| finalStatusCode | selectedNino | verificationScore     |
            | application/json | application/json | 200        | 202                   | 204             | KE000000C    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000000A    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000003A    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000004A    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000005A    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000006A    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000003I    | "verificationScore":2 |
            | application/json | application/json | 200        | 202                   | 204             | AA000003C    | "verificationScore":0 |
            | application/json | application/json | 200        | 202                   | 204             | AA000003Z    | "verificationScore":0 |
